...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_GoodsIssue Or pVal.FormTypeEx = frm_PurchaseRequest Then
...
#End Region
    ...
    Public Sub RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean)
        ...
        If oForm.TypeEx = frm_GoodsIssue Or oForm.TypeEx = frm_PurchaseRequest Then
            If (eventInfo.BeforeAction = True) Then
                Dim oMenuItem As SAPbouiCOM.MenuItem
                Dim oMenus As SAPbouiCOM.Menus
                Try
                    If oForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                        If oApplication.SBO_Application.Menus.Exists("BoM1") = False Then
                            ...
                            oCreationPackage.UniqueID = "BoM1"
                            oCreationPackage.String = "Copy from BoM"
            ...
            Else
                ...
                Try
                    If 1 = 1 Then ' oForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                        If oApplication.SBO_Application.Menus.Exists("BoM1") Then
                            oApplication.SBO_Application.Menus.RemoveEx("BoM1")
                        End If
            ...
            Select Case pVal.MenuUID
                Case "BoM1"
                    If pVal.BeforeAction = False Then
                        oForm = oApplication.SBO_Application.Forms.ActiveForm()
                        If 1 = 1 Then 'oApplication.Utilities.getEditTextvalue(oForm, "4") <> "" Then
                            Dim oObj As New clsBoMWizard_PO
