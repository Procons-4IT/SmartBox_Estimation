...
Partial Public Class Barcode
    ...
    Partial Public Class BarcodeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddBarcodeRow(ByVal Barcode As String, ByVal ItemCode As String, ByVal ItemName As String, ByVal Season As String, ByVal Price As Double, ByVal Quantity As Double) As BarcodeRow
            Dim rowBarcodeRow As BarcodeRow = CType(Me.NewRow,BarcodeRow)
            Dim columnValuesArray() As Object = New Object() {Barcode, ItemCode, ItemName, Season, Price, Quantity}
