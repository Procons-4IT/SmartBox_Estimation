Public Class clsLog_Error
    ...
    Private Const log_PROCESZ_ORDERS As String = "Log_ProcessOrders.txt"
    ...
    Public Sub WriteToLog(ByVal sText As String, ByVal Type As Log)
        ...
        Try
            ...
            Select Case Type
                Case Log.lg_PROCESZ_ORDER
                    sLogFilePath = sLogPath & "\" & log_PROCESZ_ORDERS
    ...
    Public Sub DeleteFile(ByVal Type As Log)
        ...
        Select Case Type
            Case Log.lg_PROCESZ_ORDER
                sLogFilePath = oApplication.Utilities.getApplicationPath() & "\Log\" & log_PROCESZ_ORDERS
