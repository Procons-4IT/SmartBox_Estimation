...
Public Class clsBarCodePrintingPO
    Inherits clsBase
    ...
    Public Sub LoadForm()
        Try
            oForm = oApplication.Utilities.LoadForm("frm_BarCodePrintingPO.xml", "frm_PrintBarCodePO")
            ...
            For intRow As Integer = 0 To otest.RecordCount - 1
                ...
                otest.MoveNext()
            Next
            oForm.DataSources.UserDataSources.Add("fromPO", SAPbouiCOM.BoDataType.dt_SHORT_TEXT)
            oEditText = oForm.Items.Item("4").Specific
            oEditText.DataBind.SetBound(True, "", "fromPO")
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = "frm_PrintBarCodePO" Then
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "3" Then
                                    ...
                                    '    Exit Sub
                                    'End If
                                    If oApplication.Utilities.PrintBarCode_PO(oForm) = True Then
                                ...
                                If pVal.ItemUID = "13" Then
                                    If oApplication.SBO_Application.MessageBox("Confirm to Print BarCodes ?", , "Continue", "Cancel") = 2 Then
                                        Exit Sub
                                    End If
                                    oApplication.Utilities.PrintbarCode_Report_PO(oForm)
                                    'oApplication.Utilities.Message("Operation completed successfully", SAPbouiCOM.BoStatusBarMessageType.smt_Success)
                                    'oForm.Close()
                                End If
                            Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                                ...
                                Try
                                    ...
                                    If pVal.ItemUID = "4" Then 'Or pVal.ItemUID = "6" Then
